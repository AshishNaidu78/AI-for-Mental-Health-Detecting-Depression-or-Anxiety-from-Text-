...
log_handler = RotatingFileHandler('app.log', maxBytes=1024*1024*10, backupCount=5)
logging.basicConfig(
    level=logging.INFO,
...
app.config['SESSION_COOKIE_SECURE'] = os.environ.get('PRODUCTION', 'False').lower() == 'true'  # Enable in production with HTTPS
